...
const Main = () => {
  return (
    <div className="max-h-screen bg-pageBg p-1 -mt-10 w-[100vh]">
      ...
      <div className="flex items-center mb-4">
        ...
        <span className="ml-2 text-primary text-xl font-bold">Boys Hostel</span>
      </div>
      <p className="text-tertiary font-medium mb-4">Manage mess / Boys Hostel</p>
  ...
  <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
    ...
    <Link to="/manage-mess/boys-hostel/groceries" className="text-primary font-extrabold text-4xl transform transition-transform duration-300 hover:scale-150">→</Link>
    </div>
  </div>
  ...
  <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
    ...
    <Link to="/bill-distribution" className="text-primary font-extrabold text-4xl transform transition-transform duration-300 hover:scale-150">→</Link>
    </div>
  </div>
</div>
    </div>

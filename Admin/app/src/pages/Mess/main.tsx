...
const Main = () => {
  ...
  return (
    <div className="max-h-screen bg-gray-100 dark:bg-gray-800 p-1 -mt-10 w-[100vh]">
      ...
      <p className="text-gray-500 font-medium mb-4">Manage mess / {hostel === 'Boys' ? 'Boys' : 'Girls'} Hostel</p>

      {/* Full-Screen Grid Section */}
      <div className="grid grid-cols-2 gap-6 content-center ">
        {/* Staff Salaries Card */}
        <div className="flex flex-col items-center justify-center dark:bg-gray-600 dark:text-gray-200 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
          ...
          <Link
            ...
            className="dark:text-gray-200 text-gray-900 font-extrabold text-4xl transform transition-transform duration-300 hover:scale-150"
          >
            →
          </Link>
          </div>
        ...
        <div className="flex flex-col items-center justify-center dark:bg-gray-600 dark:text-gray-200 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
          ...
          <Link to={`/manage-mess/${hostel === 'Boys' ? 'Boys' : 'Girls'}/groceries`} className="dark:text-gray-200 text-gray-900 font-extrabold text-4xl transform transition-transform duration-300 hover:scale-150">→</Link>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center dark:bg-gray-600 dark:text-gray-200 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
          ...
          <Link to={`/manage-mess/${hostel === 'Boys' ? 'Boys' : 'Girls'}/attendance`} className="dark:text-gray-200 text-gray-900 font-extrabold text-4xl transform transition-transform duration-300 hover:scale-150">→</Link>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center dark:bg-gray-600 dark:text-gray-200 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
          ...
          <Link to={`/manage-mess/${hostel === 'Boys' ? 'Boys' : 'Girls'}/bill-distribution`} className="dark:text-gray-200 text-gray-900 font-extrabold text-4xl transform transition-transform duration-300 hover:scale-150">→</Link>
          </div>
        </div>
      </div>
    </div>
